...
let Users = (_dec = (0, _typeorm.Entity)('users', {
  schema: 'beeginscrum'
}), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.Column)('varchar', {
  name: 'name',
  length: 255
}), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.CreateDateColumn)(), _dec7 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec8 = (0, _typeorm.UpdateDateColumn)(), _dec9 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec10 = (0, _typeorm.OneToMany)(() => _Room.default, rooms => rooms.admin), _dec11 = Reflect.metadata("design:type", Array), _dec12 = (0, _typeorm.OneToMany)(() => _UsersRoom.default, rooms => rooms.user), _dec13 = Reflect.metadata("design:type", Array), _dec(_class = (_class2 = (_temp = class Users {
  constructor() {
    ...
    _initializerDefineProperty(this, "usersRoom", _descriptor6, this);
  }
  ...
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "admin", [_dec10, _dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "usersRoom", [_dec12, _dec13], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
